...
?>
<form action="<?php echo JRoute::_('index.php?option=com_ebilling&view=profiles&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a href="#" class="pointer" onclick="if (window.parent) window.parent.<?php echo $function;?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->name)); ?>');">
