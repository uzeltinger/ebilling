...
class EbillingViewProfiles extends JViewLegacy
	{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			EbillingHelper::addSubmenu('profiles');
		}
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('Perfiles'), 'profiles.png');
			...
			JToolBarHelper::divider();
			JToolBarHelper::deleteList('', 'profiles.delete','JTOOLBAR_TRASH');
