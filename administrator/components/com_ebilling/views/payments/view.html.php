...
class EbillingViewPayments extends JViewLegacy
	{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		{
			EbillingHelper::addSubmenu('payments');
		}
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('payments'), 'payments.png');
			JToolBarHelper::custom('payment.add', 'new.png', 'new_f2.png','JTOOLBAR_NEW', false);
		
			JToolBarHelper::custom('payment.edit', 'edit.png', 'edit_f2.png','JTOOLBAR_EDIT', true);		
			...
			JToolBarHelper::divider();
			JToolBarHelper::deleteList('', 'payments.delete','JTOOLBAR_TRASH');
