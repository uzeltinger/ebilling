...
class ElectronicBilling extends AfipWebService {
	...
	**/
	...
	{
		return $this->ExecuteRequest('FEParamGetPtosVenta')->ResultGet;
	}

	
	public function GetCompUltimoAutorizado()
	{
		return $this->ExecuteRequest('FECompUltimoAutorizado')->ResultGet;
	}	
